...
$query = 'SELECT a.Folio,a.Fecha,b.Descripcion As Area ,c.Descipcion As Estatus  FROM requis a INNER JOIN catcareas b on a.IdArea = b.IdArea INNER JOIN catcestatus c on a.IdEstatus = c.IdEstatus WHERE a.Fecha = "'.$FechaBusqueda.'"  ORDER BY a.Folio ';
